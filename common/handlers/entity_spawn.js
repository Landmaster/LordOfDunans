...
PacketHandler.register(0x5, Packet.entitySpawnedPacket, (packet, mainInstance, ctx) => {
...
PacketHandler.register(0x6, Packet.entityDeathPacket, (packet, mainInstance, ctx) => {
	if (Side.getSide() === Side.CLIENT && mainInstance.theWorld) {
